    ...
    public class UIPackage
    {
        ...
        public static string branch
        {
            ...
            set
            {
                ...
                _constructing++;
                foreach (var item in UIObjectFactory.branchObjs)
                {
                    float width = item.width;
                    float height = item.height;
                    item.ConstructFromResource();
                    item.SetSize(width, height);
                    Controller controller = item.parent?.asCom?.GetController("Language");
                    if (controller != null)
                        controller.selectedPage = _branch;
                }
                _constructing--;
            }
        }
