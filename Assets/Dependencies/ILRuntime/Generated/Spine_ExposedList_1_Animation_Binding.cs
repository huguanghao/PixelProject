...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Spine_ExposedList_1_Animation_Binding
    {
        ...
        static StackObject* GetEnumerator_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Spine.ExposedList<Spine.Animation> instance_of_this_method = (Spine.ExposedList<Spine.Animation>)typeof(Spine.ExposedList<Spine.Animation>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
