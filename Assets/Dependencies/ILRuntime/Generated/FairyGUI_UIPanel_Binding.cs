...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_UIPanel_Binding
    {
        ...
        static StackObject* get_ui_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* CreateUI_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* CopyToStack_componentName_1(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
        ...
        static StackObject* AssignFromStack_componentName_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
