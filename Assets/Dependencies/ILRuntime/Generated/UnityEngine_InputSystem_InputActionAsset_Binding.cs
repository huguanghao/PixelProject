...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_InputSystem_InputActionAsset_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, FindActionMap_0);


        }


        static StackObject* FindActionMap_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
