...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_MaterialPropertyBlock_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SetTexture_1);
            args = new Type[]{};
        ...
        static StackObject* SetTexture_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
