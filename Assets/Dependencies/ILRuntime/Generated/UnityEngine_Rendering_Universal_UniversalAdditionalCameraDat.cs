...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Rendering_Universal_UniversalAdditionalCameraData_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_cameraStack_0);


        }


        static StackObject* get_cameraStack_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
