...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_Generic_LinkedListNode_1_ILTypeInstance_Binding
    {
        ...
        static StackObject* get_Next_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* get_Previous_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
