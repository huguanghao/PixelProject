...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Keyframe_Binding
    {
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref UnityEngine.Keyframe instance_of_this_method)
        {
        ...
        static StackObject* get_value_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            UnityEngine.Keyframe instance_of_this_method = (UnityEngine.Keyframe)typeof(UnityEngine.Keyframe).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
