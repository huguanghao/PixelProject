...
{
    unsafe class Spine_Skin_Binding
    {
        ...
        static StackObject* get_Name_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Spine.Skin instance_of_this_method = (Spine.Skin)typeof(Spine.Skin).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
