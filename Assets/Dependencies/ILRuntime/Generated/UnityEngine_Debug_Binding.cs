...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Debug_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_isDebugBuild_2);
            args = new Type[]{};
            method = type.GetMethod("Break", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Break_3);
        ...
        static StackObject* get_isDebugBuild_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* Break_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
