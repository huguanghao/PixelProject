...
{
    unsafe class YKGame_Runtime_FlipConfig_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(YKGame.Runtime.FlipConfig);
        ...
        static StackObject* AssignFromStack_type_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            YKGame.Runtime.FlipMethodType @type = (YKGame.Runtime.FlipMethodType)typeof(YKGame.Runtime.FlipMethodType).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)20);
            ((YKGame.Runtime.FlipConfig)o).type = @type;
