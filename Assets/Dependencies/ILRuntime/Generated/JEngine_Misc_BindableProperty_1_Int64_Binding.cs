...
{
    unsafe class JEngine_Misc_BindableProperty_1_Int64_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(JEngine.Misc.BindableProperty<System.Int64>);
        ...
        static StackObject* set_Value_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            JEngine.Misc.BindableProperty<System.Int64> instance_of_this_method = (JEngine.Misc.BindableProperty<System.Int64>)typeof(JEngine.Misc.BindableProperty<System.Int64>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        {
            return ((JEngine.Misc.BindableProperty<System.Int64>)o).OnChangeWithOldVal;
        }

        static StackObject* CopyToStack_OnChangeWithOldVal_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((JEngine.Misc.BindableProperty<System.Int64>)o).OnChangeWithOldVal;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_OnChangeWithOldVal_0(ref object o, object v)
        {
            ((JEngine.Misc.BindableProperty<System.Int64>)o).OnChangeWithOldVal = (System.Action<System.Int64, System.Int64>)v;
        }
        ...
        static StackObject* AssignFromStack_OnChangeWithOldVal_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((JEngine.Misc.BindableProperty<System.Int64>)o).OnChangeWithOldVal = @OnChangeWithOldVal;
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new JEngine.Misc.BindableProperty<System.Int64>(@val);
