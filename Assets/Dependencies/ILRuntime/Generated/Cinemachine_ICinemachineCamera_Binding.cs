...
{
    unsafe class Cinemachine_ICinemachineCamera_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Cinemachine.ICinemachineCamera);
        ...
        static StackObject* set_Follow_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Cinemachine.ICinemachineCamera instance_of_this_method = (Cinemachine.ICinemachineCamera)typeof(Cinemachine.ICinemachineCamera).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
