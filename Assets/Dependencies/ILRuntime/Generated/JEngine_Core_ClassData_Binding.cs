...
namespace ILRuntime.Runtime.Generated
{
    unsafe class JEngine_Core_ClassData_Binding
    {
        ...
        static StackObject* CopyToStack_classNamespace_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
        ...
        static StackObject* AssignFromStack_classNamespace_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
        ...
        static StackObject* CopyToStack_className_1(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
        ...
        static StackObject* AssignFromStack_className_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* CopyToStack_activeAfter_2(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
        ...
        static StackObject* AssignFromStack_activeAfter_2(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
