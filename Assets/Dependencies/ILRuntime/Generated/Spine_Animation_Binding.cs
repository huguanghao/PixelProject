...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Spine_Animation_Binding
    {
        ...
        static StackObject* get_Name_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Spine.Animation instance_of_this_method = (Spine.Animation)typeof(Spine.Animation).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
