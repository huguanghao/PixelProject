...
namespace ILRuntime.Runtime.Generated
{
    unsafe class JEngine_Core_Tools_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, CanAssignTo_0);
            ...
            app.RegisterCLRMethodRedirection(method, DestroyHotComponent_1);
            args = new Type[]{typeof(UnityEngine.GameObject), typeof(System.String)};
            method = type.GetMethod("GetHotComponent", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetHotComponent_2);


        }


        static StackObject* CanAssignTo_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = JEngine.Core.Tools.CanAssignTo(@instance, @type);
        ...
        static StackObject* DestroyHotComponent_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* GetHotComponent_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            var result_of_this_method = JEngine.Core.Tools.GetHotComponent(@gameObject, @typeName);
