...
{
    unsafe class FairyGUI_GObjectPool_Binding_InitCallbackDelegate_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(FairyGUI.GObjectPool.InitCallbackDelegate);
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            FairyGUI.GObjectPool.InitCallbackDelegate instance_of_this_method = (FairyGUI.GObjectPool.InitCallbackDelegate)typeof(FairyGUI.GObjectPool.InitCallbackDelegate).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
