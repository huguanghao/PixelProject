...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Timeline_SignalReceiver_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetReaction_0);


        }


        static StackObject* GetReaction_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
