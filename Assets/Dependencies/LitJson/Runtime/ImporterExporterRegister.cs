...
namespace JEngine.Core
{
    public class ImporterExporterRegister : IRegisterHelper
    {
        public void Register(AppDomain appdomain)
        {
            ...
            JsonMapper.RegisterImporter<int, int[]>(input => new int[] { input });
            JsonMapper.RegisterImporter<float, float[]>(input => new float[] { input });
            JsonMapper.RegisterImporter<string, string[]>(input => new string[] { input });
        }
    }
}